...
export const getByUser = async (req, res, next) => {
    try {
        let comments = await commentService.getByUser(req.params.userId, req.body || null);
        if(comments)
            responseUtil.response(res, httpStatus.OK, `Sucess`, comments);
        else
            responseUtil.response(res, httpStatus.NOT_FOUND, `Failed`);
...
export const getOne = async (req, res, next) => {
    try {
        ...
        if(comment)
            responseUtil.response(res, httpStatus.OK, `Sucess`, comment);
        else
            responseUtil.response(res, httpStatus.NOT_FOUND, `Failed`);
...
export const update = async (req, res, next) => {
    try {
        let comment = await commentService.update(req.body, req.params.commentId, req.user._id);
        if(comment)
            responseUtil.response(res, httpStatus.OK, `Sucess`, comment);
        else
            responseUtil.response(res, httpStatus.NOT_FOUND, `Failed`);
...
export const softDelete = async (req, res, next) => {
    try {
        let comment = await commentService.softDelete(req.params.commentId, req.user._id);
        if(comment)
            responseUtil.response(res, httpStatus.OK, `Sucess`, comment);
        else
            responseUtil.response(res, httpStatus.NOT_FOUND, `Failed`);
...
export const remove = async (req, res, next) => {
    try {
        let comment = await commentService.remove(req.params.commentId, req.user._id);
        if(comment)
            responseUtil.response(res, httpStatus.OK, `Sucess`, comment);
        else
            responseUtil.response(res, httpStatus.NOT_FOUND, `Failed`);
