...
const errorHandler = (err, req, res, next) => {
    if(err instanceof ApplicationError) 
        return responseUtil.response(res, err.statusCode, errorUtil.errorFormat(err));
    return responseUtil.response(res, httpStatus.INTERNAL_SERVER_ERROR, err.message);
}
