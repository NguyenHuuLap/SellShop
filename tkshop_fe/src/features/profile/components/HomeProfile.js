...
import { Card, EventAvailable, Paid, WorkspacePremium } from "@mui/icons-material";
...
const buttonData = [
    ...
    { img: img_yourpurchase, title: 'Đơn hàng của bạn', count: '0 Đơn hàng', backgroundColor: '#edf1fd', path: '/your-purchases' },
    { img: img_yourranking, title: 'Hạng của bạn', count: 'Bạn đang là TKNull', backgroundColor: '#f1f8fe', path: '/your-ranking' },
];
    ...
    return (
        <>
            <Grid container item sx={{position:'relative'}} spacing={2} >
                        ...
                        <center>
                            ...
                            <Grid container spacing={1} sx={{marginTop:'8px', marginBottom:'4px'}}>
                                ...
                                <Grid item xs={4}>
                                    ...
                                    <WorkspacePremium sx={{width:'60px', color:'#4287ED', height:'60px', marginTop:'4px' }}/>
                                    <Typography>TKNull</Typography>
                                </Grid>
                                <Grid item xs={4}>
                                    <Typography>Điểm tích lũy từ 01/01/2022</Typography>
                                    <Paid sx={{width:'60px', color:'#4287ED', height:'60px', marginTop:'4px' }}/>
                ...
                <Grid item sx={{ position: "relativve", }}>
                    <Grid sx={{ '--Grid-borderWidth': '1px', border: 'var(--Grid-borderWidth) solid',borderColor: 'divider',
                        height: '286px', width: '450px', borderRadius: '10px', backgroundColor:'#fef5f0'  }}>
                        <center>
                            <Typography variant='h6' sx={{width:'260px', borderRadius:'10px', color:'white', marginTop:'14px',
                            backgroundColor:'#4287ED'}}>
                                CHƯƠNG TRÌNH NỔI BẬT</Typography>
                                <Box sx={{ maxWidth: 400, flexGrow: 1 }}>
                                <Carousel>
                                    {images.map((item, index) => (
                                        <img key={index} src={item.imgPath} style={{marginTop:'8px', width: '100%', height:'200px' }} />
                                    ))}
                                </Carousel>
                                </Box>
                        </center>
            ...
            <Grid container item sx={{ position: 'relative', marginTop: '14px' }}>
                {buttonData.map((button, index) => (
                    ...
                    >
                    <Avatar src={button.img} sx={{ border: '2px solid #1976d2', width: 60, height: 60, marginTop: '20px' }} />
                    <Typography sx={{ fontWeight: 'bold', fontSize: '22px', marginTop: '10px' }}>{button.title}</Typography>
