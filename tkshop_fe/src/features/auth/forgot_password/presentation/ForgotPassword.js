            ...
            <center>
                <Container sx={{width:'1200px', marginTop: '15px'}}>
                    <Toolbar sx={{flexDirection: 'column'}}>
                        ...
                        <TextField id="input-with-sx" label="Nhập số điện thoại/email" variant="standard" 
                            sx={{width: '650px', marginBottom:'15px', marginBottom:'30px'}}/>
                        <Button sx={{width: '400px', borderRadius: '20px'}} variant="contained">Đăng nhập</Button>
                    </Toolbar>
                </Container>
            </center>
        </>
