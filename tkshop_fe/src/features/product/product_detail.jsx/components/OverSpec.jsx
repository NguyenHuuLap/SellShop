...
export const GetIcons = ({ variantKey }) => {
    ...
    else if (variantKey === 'card')
        return (<FontAwesomeIcon icon={faDesktop} />);
    else if (variantKey === 'cpu')
    ...
    return !overSpecs ? (<>Loading</>) : (
        <OverSpecCard>
            <CardContent>
                ...
                <Button variant='text' onClick={() => setOpen(true)} sx={{ width: "100%" }}>Xem chi tiết thông số</Button>
            </CardContent>
        </OverSpecCard>
